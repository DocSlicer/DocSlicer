...
def extract_native_metadata(package: DocxPackage) -> dict[str, Any]:
    """
    Read docProps/core.xml and docProps/app.xml and return the shared
    native-metadata shape:

        title_meta, author_meta, language_meta, page_count,
        created, modified, last_modified_by, application, app_version, generator
    """
    ...
    if core is not None:
        ...
        # Timestamps are W3CDTF (ISO-8601) already, e.g. "2018-08-20T14:41:00Z".
    ...
    # Pages/Google Docs write no <Application>; classify by package shape.
