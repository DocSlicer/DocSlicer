    ...
    rows.append(
        {
            ...
            "has_link": bool(hyperlink_id or bookmark_id),
            "link_type": "external" if hyperlink_url else ("internal" if (hyperlink_id or bookmark_id) else None),
            "link_url": hyperlink_url or bookmark_id or None,
